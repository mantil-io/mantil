...
func terraformModulesDynamodbZip() (*asset, error) {
	...
	info := bindataFileInfo{name: "terraform/modules/dynamodb.zip", size: 783, mode: os.FileMode(420), modTime: time.Unix(1627395709, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func terraformModulesFuncsZip() (*asset, error) {
	...
	info := bindataFileInfo{name: "terraform/modules/funcs.zip", size: 4655, mode: os.FileMode(420), modTime: time.Unix(1627395709, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func terraformTemplatesMainTf() (*asset, error) {
	...
	info := bindataFileInfo{name: "terraform/templates/main.tf", size: 2411, mode: os.FileMode(420), modTime: time.Unix(1627383656, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
