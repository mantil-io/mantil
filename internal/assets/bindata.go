...
func terraformModulesDynamodbZip() (*asset, error) {
	...
	info := bindataFileInfo{name: "terraform/modules/dynamodb.zip", size: 956, mode: os.FileMode(420), modTime: time.Unix(1626856279, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func terraformModulesFuncsZip() (*asset, error) {
	...
	info := bindataFileInfo{name: "terraform/modules/funcs.zip", size: 4815, mode: os.FileMode(420), modTime: time.Unix(1626856279, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func awsProjectPolicyJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "aws/project-policy.json", size: 784, mode: os.FileMode(420), modTime: time.Unix(1626856234, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
